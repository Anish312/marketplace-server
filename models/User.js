...
ownerUserSchema.methods.getJWTToken = function() {
    return jwt.sign({id: this._id}, "fdgdfgdfgfdg", {
      expiresIn : "5d"
    }) 
}

ownerUserSchema.methods.comparePassword = async function(enteredPassword) {
    return await  bcrypt.compare(enteredPassword, this.password);
  }
  

  ownerUserSchema.methods.getResetPassword = async function(enterResetPassword) {
